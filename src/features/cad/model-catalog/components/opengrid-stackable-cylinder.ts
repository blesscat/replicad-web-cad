...
export const opengridStackableCylinderDefinition: ModelDefinition = {
  ...
  selectionDescription:
    '預設為 2 mm 壁厚、5 mm 底厚並保留內側 0.6 mm 圓角的開口圓柱；高度文字輸入 10–500 mm、slider 10–200 mm，外徑維持 20–300 mm。可切換原本的薄底模式（3 mm 平面、內側平行 45° 斜面），或底板模式（3 mm 底板、預設式內壁圓角、無內側斜坡，切除紅線以下腳端，外側 45° 後直接平底）。底部孔洞可一次全部開關：預設為 Ø5.05 mm × 4 mm 接 Ø4.05 mm × 1 mm，薄底與底板模式為 2 mm + 1 mm；Ø4 mm 軸搭配 Ø7 mm × 0.8 mm 法蘭時由 Ø4.05 mm 肩部止擋。並依 14 mm 間距只在 X/Y 最外圈產生最多四個孔，底板模式沿用預設模式的孔位安全計算，孔外緣離外壁至少 2 mm。三種模式都保留相同外徑堆疊、0.2 mm 徑向間隙、上緣內側 2 mm/45° 導角。',
