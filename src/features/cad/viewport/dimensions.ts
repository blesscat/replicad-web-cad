import type { BoxBounds, BoxParameters, DimensionKey } from "../../../cad-contract/units";
...
function createWidthAnnotation(
  ...
  return createAnnotation({
    ...
    endTicks: [
      ...
      segment(point(lineEnd[0], lineEnd[1] - tickSize / 2, lineEnd[2]), point(lineEnd[0], lineEnd[1] + tickSize / 2, lineEnd[2])),
    ],
    labelPosition: point(
...
function createDepthAnnotation(
  ...
  return createAnnotation({
    ...
    endTicks: [
      ...
      segment(point(lineEnd[0] - tickSize / 2, lineEnd[1], lineEnd[2]), point(lineEnd[0] + tickSize / 2, lineEnd[1], lineEnd[2])),
    ],
    labelPosition: point(
      bounds.max[0] + offset,
