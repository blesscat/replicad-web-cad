export const zhHantMessages = {
  ...
  'about.supportDescription':
    '如果 Shape Shortcut 對你有幫助，可以透過 Portaly 支持後續開發。',
  ...
  'panel.wallCover.details':
    '每個字會產生一個獨立的雙色平放 cover；空白會忽略，最多輸入 8 個字。可選擇是否保留 OpenConnect 底部階梯開孔。',
  'panel.wallCover.inputAria': 'Wall Cover 文字',
  'panel.wallCover.characterCount': '{count} / {max} 字',
  'panel.wallCover.font': '預設繁體中文字型：{font}',
  'panel.wallCover.openConnect': 'OpenConnect 底部階梯開孔',
...
export const enMessages: { [Key in keyof typeof zhHantMessages]: string } = {
  ...
  'about.supportDescription':
    'If Shape Shortcut is useful to you, you can support continued development through Portaly.',
  ...
  'panel.wallCover.details':
    'Each character creates one independent, flat two-color cover. Whitespace is ignored; enter up to 8 characters. Choose whether to keep the OpenConnect underside stepped opening.',
  'panel.wallCover.inputAria': 'Wall Cover text',
  'panel.wallCover.characterCount': '{count} / {max} characters',
  'panel.wallCover.font': 'Default Traditional Chinese font: {font}',
  'panel.wallCover.openConnect': 'OpenConnect underside stepped opening',
