export const zhHantMessages = {
  ...
  'parameter.magnetHoleLength': '磁鐵孔長度',
  'parameter.magnetHoleWidth': '磁鐵孔寬度',
  'parameter.magnetHoleDiameter': '磁鐵孔直徑',
  'parameter.magnetHoleThickness': '磁鐵孔厚度',
...
export const enMessages: { [Key in keyof typeof zhHantMessages]: string } = {
  ...
  'parameter.magnetHoleLength': 'Magnet-hole length',
  'parameter.magnetHoleWidth': 'Magnet-hole width',
  'parameter.magnetHoleDiameter': 'Magnet-hole diameter',
  'parameter.magnetHoleThickness': 'Magnet-hole thickness',
  ...
  'panel.snap.magnetNone': 'No magnet hole',
