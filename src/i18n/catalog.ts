export const zhHantMessages = {
  ...
  'navigation.theme': '色彩模式',
  'navigation.light': '淺色',
  'navigation.dark': '深色',
  'navigation.switchToLight': '切換為淺色模式',
  'navigation.switchToDark': '切換為深色模式',
  'support.dialogTitle': '選擇贊助方式',
  'support.dialogDescription': '請選擇你方便使用的贊助平台。',
  'support.close': '關閉贊助選項',
  'support.portalyName': 'Portaly',
  'support.portalyDescription': '台灣在地付款',
  'support.portalyAria': '透過 Portaly 贊助',
  'support.kofiName': 'Ko-fi',
  'support.kofiDescription': 'PayPal／國際付款',
  'support.kofiAria': '透過 Ko-fi 贊助',
  'navigation.language': '語言',
  'navigation.switchToEnglish': 'English',
  'navigation.switchToZhHant': '繁體中文',
  'navigation.footer': '頁尾導覽',
  'navigation.product': '產品',
  'navigation.project': '專案',
  ...
  'home.explore.eyebrow': '從這裡開始',
  'home.explore.title': '依照你的使用情境，找到適合的系統',
  'home.explore.desk.title': 'OpenGrid Desk',
  'home.explore.desk.description':
    '從桌面 Board、Snap 與可調整收納盒開始，快速組出自己的 Desk System。',
  'home.explore.desk.cta': '開始 Desk System →',
  ...
  'home.maker.githubCta': 'GitHub',
  'home.maker.emailCta': '公開 Email',
  'home.maker.supportCta': '贊助 Shape Shortcut',
  'about.metaTitle': 'Shape Shortcut by Blesscat｜獨立開發者與 3D 列印愛好者',
  'about.description':
    '認識 Shape Shortcut by Blesscat：一個由獨立開發者與 3D 列印愛好者製作、目前正在 prototype 階段的瀏覽器 CAD 工具。',
  'about.eyebrow': 'Maker / developer',
  'about.title': 'Shape Shortcut by Blesscat',
  'about.role': '獨立開發者、3D 列印愛好者',
  'about.status': '目前狀態：Prototype',
  'about.portraitAlt': 'Blesscat 的插畫肖像',
  'about.intro':
  ...
  'about.linksHeading': '找到我',
  'about.github': 'GitHub',
  'about.email': 'blesscat@gmail.com',
  'about.support': '贊助這個專案',
  'about.supportDescription':
    '如果 Shape Shortcut 對你有幫助，可以選擇合適的贊助方式支持後續開發。',
  'about.modelsCta': '瀏覽模型 →',
  'about.docsCta': '閱讀文件 →',
  ...
  'docs.title': 'Shape Shortcut 文件',
  'docs.description':
    'Shape Shortcut 的 Desk System 快速入門、Wall System 參考，以及目前 CAD 模型、參數、匯出與瀏覽器需求文件。',
  'docs.sectionNav': '文件章節',
  'docs.sectionNav.desk': 'Desk 快速入門',
  'docs.sectionNav.wall': 'Wall System',
  'docs.sectionNav.models': '模型參考',
  'docs.sectionNav.common': '共通參考',
  'docs.wall.title': 'Wall System 快速參考',
  'docs.wall.intro':
    'Wall Related 模型把 OpenGrid 的 Board、Snap、Wall Cover 與 OpenConnect Shelf 組合到牆面使用情境；先從 Board 與 Snap 的介面開始，再依需求加入 cover、divider 或層架。',
  'docs.wall.workflowHeading': 'Wall 系統元件',
  'docs.wall.board.title': 'OpenGrid Wall Board',
  'docs.wall.board.body':
    'Wall Board 是牆面配置的基礎平面，可調整格數與板型，並透過對應的 Snap 連接其他元件。',
  'docs.wall.board.cta': '開啟 Wall Board →',
  'docs.wall.board.alt': 'OpenGrid Wall Board 預覽',
  'docs.wall.snap.title': 'OpenGrid Wall Snap',
  'docs.wall.snap.body':
    'Wall Snap 提供牆面使用的介面選項；請依 Board 與實際安裝方式選擇合適的變種。',
  'docs.wall.snap.cta': '開啟 Wall Snap →',
  'docs.wall.snap.alt': 'OpenGrid Wall Snap 預覽',
  'docs.wall.cover.title': 'OpenGrid Wall Cover',
  'docs.wall.cover.body':
    'Wall Cover 是使用指定 Snap cover STEP 的雙色平面 cover，適合整理牆面外觀與局部遮蔽。',
  'docs.wall.cover.cta': '開啟 Wall Cover →',
  'docs.wall.cover.alt': 'OpenGrid Wall Cover 預覽',
  'docs.wall.shelf.title': 'OpenConnect Shelf',
  'docs.wall.shelf.body':
  ...
  'panel.snap.systemAria': 'OpenGrid Snap 系統',
  'panel.snap.systemDesk': '桌面系統',
  'panel.snap.systemWall': '掛牆系統',
  'panel.snap.openConnect': 'OpenConnect',
...
export const enMessages: { [Key in keyof typeof zhHantMessages]: string } = {
  ...
  'navigation.theme': 'Color theme',
  'navigation.light': 'Light',
  'navigation.dark': 'Dark',
  'navigation.switchToLight': 'Switch to light mode',
  'navigation.switchToDark': 'Switch to dark mode',
  'support.dialogTitle': 'Choose a support option',
  'support.dialogDescription':
    'Choose the donation platform that works for you.',
  'support.close': 'Close support options',
  'support.portalyName': 'Portaly',
  'support.portalyDescription': 'Taiwan-local payment',
  'support.portalyAria': 'Support through Portaly',
  'support.kofiName': 'Ko-fi',
  'support.kofiDescription': 'PayPal / international payments',
  'support.kofiAria': 'Support through Ko-fi',
  ...
  'home.heroVisual.caption':
    'Turn an idea into a printable file with parameters, a live 3D preview, and an export workflow.',
  ...
  'home.explore.eyebrow': 'Choose a starting point',
  'home.explore.title': 'Find the system that fits what you are making',
  'home.explore.desk.title': 'OpenGrid Desk',
  'home.explore.desk.description':
    'Start with a desk Board, Snaps, and adjustable containers to build your own Desk System.',
  'home.explore.desk.cta': 'Start Desk System →',
  ...
  'home.maker.githubCta': 'GitHub',
  'home.maker.emailCta': 'Public email',
  'home.maker.supportCta': 'Support Shape Shortcut',
  'about.metaTitle':
    'Shape Shortcut by Blesscat | Independent developer and 3D-printing enthusiast',
  'about.description':
    'Meet Shape Shortcut by Blesscat, a browser CAD project built by an independent developer and 3D-printing enthusiast. The project is currently in the prototype stage.',
  'about.eyebrow': 'Maker / developer',
  'about.title': 'Shape Shortcut by Blesscat',
  'about.role': 'Independent developer, 3D-printing enthusiast',
  'about.status': 'Current status: Prototype',
  'about.portraitAlt': 'Illustrated portrait of Blesscat',
  'about.intro':
  ...
  'about.linksHeading': 'Find me',
  'about.github': 'GitHub',
  'about.email': 'blesscat@gmail.com',
  'about.support': 'Support this project',
  'about.supportDescription':
    'If Shape Shortcut is useful to you, you can support continued development through one of the support options.',
  'about.modelsCta': 'Browse models →',
  'about.docsCta': 'Read the docs →',
  ...
  'docs.title': 'Shape Shortcut documentation',
  'docs.description':
    'Shape Shortcut Desk System quick start, Wall System reference, and current CAD model, parameter, export, and browser documentation.',
  'docs.sectionNav': 'Documentation sections',
  'docs.sectionNav.desk': 'Desk quick start',
  'docs.sectionNav.wall': 'Wall System',
  'docs.sectionNav.models': 'Model reference',
  'docs.sectionNav.common': 'Shared reference',
  'docs.wall.title': 'Wall System quick reference',
  'docs.wall.intro':
    'Wall Related models bring OpenGrid Boards, Snaps, Wall Covers, and OpenConnect Shelf into wall-mounted workflows. Start with the Board and Snap interface, then add a cover, divider, or shelf as needed.',
  'docs.wall.workflowHeading': 'Wall System components',
  'docs.wall.board.title': 'OpenGrid Wall Board',
  'docs.wall.board.body':
    'The Wall Board is the base plane for a wall layout. Adjust its grid and profile, then connect other components with matching Snaps.',
  'docs.wall.board.cta': 'Open Wall Board →',
  'docs.wall.board.alt': 'OpenGrid Wall Board preview',
  'docs.wall.snap.title': 'OpenGrid Wall Snap',
  'docs.wall.snap.body':
    'Wall Snap provides the interface options used on a wall. Choose a variant that matches the Board and your installation approach.',
  'docs.wall.snap.cta': 'Open Wall Snap →',
  'docs.wall.snap.alt': 'OpenGrid Wall Snap preview',
  'docs.wall.cover.title': 'OpenGrid Wall Cover',
  'docs.wall.cover.body':
    'Wall Cover is a two-color surface cover made from the supplied Snap cover STEP, useful for cleaning up the wall surface and hiding selected areas.',
  'docs.wall.cover.cta': 'Open Wall Cover →',
  'docs.wall.cover.alt': 'OpenGrid Wall Cover preview',
  'docs.wall.shelf.title': 'OpenConnect Shelf',
  'docs.wall.shelf.body':
  ...
  'panel.seat.detachableCornerSeatDescription':
    'Create retaining sockets for separately printed corner seats.',
  'panel.seat.integrated': 'Integrated seats',
  'panel.seat.integratedDescription':
    'Create downward Ø5 × 3.8 mm integrated seats with a 0.2 mm bottom chamfer.',
  ...
  'panel.snap.systemAria': 'OpenGrid Snap system',
  'panel.snap.systemDesk': 'Desktop System',
  'panel.snap.systemWall': 'Wall System',
  'panel.snap.openConnect': 'OpenConnect',
