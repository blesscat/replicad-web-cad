...
const DETACHABLE_SEAT_NOMINAL_VOLUME = 83.5724776437
const DETACHABLE_SEAT_KEY_WIDTH = 1.94
const DETACHABLE_LOCK_INDICATOR_WIDTH = 0.4
const DETACHABLE_LOCK_INDICATOR_RADIAL_LENGTH = 2
const DETACHABLE_LOCK_INDICATOR_DEPTH = 0.2
