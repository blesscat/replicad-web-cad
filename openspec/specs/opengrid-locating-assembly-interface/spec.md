...
geometry. The male MUST have a 5 mm maximum locating diameter, a 3 mm locating
height, a 0.2 mm-high lead-in from Ø4.6 mm to Ø5 mm, a 1.8 mm-wide keyed
retaining head whose 45-degree taper ends at Z=4.35 mm, a 0.15 mm-high flat wear
surface, and a total height of 4.5 mm. The female socket material MUST have a
Ø7 mm by 1.5 mm outer envelope, a 2 mm-wide keyed passage, and the canonical
pair of retaining tabs. The straight key-width clearance MUST be 0.1 mm per
side.
...
- **THEN** it MUST receive male body diameter 5 mm, body height 3 mm, lead-in
  height 0.2 mm, lead-in tip diameter 4.6 mm, key width 1.8 mm, taper top Z
  4.35 mm, wear height 0.15 mm, and total height 4.5 mm
- **AND** it MUST receive female outer diameter 7 mm, depth 1.5 mm, passage
...
- **AND** it MUST remain Ø5 mm through the locating section ending at Z=3 mm

#### Scenario: Raised wear surface preserves the seating datum

- **WHEN** the fixed male seat is seated in the matching female socket
- **THEN** its locating section MUST still extend exactly 3 mm below the box
  bottom datum
- **AND** the raised wear surface MUST occupy Z=4.35 mm through Z=4.5 mm in the
...
The canonical male and female reference shapes MUST each be a valid non-empty
single solid. The male MUST have bounds `[-2.5, -2.5, 0]` through
`[2.5, 2.5, 4.5]` and nominal volume 66.7032674 mm³. The female socket-material
reference MUST have bounds `[-3.5, -3.5, 3]` through `[3.5, 3.5, 4.5]` and
nominal volume 38.4253392 mm³. Bounds and volume comparisons MAY use the
project's configured B-Rep tolerance.
