...
the sloped surface extending inward from the Full area for approximately one
full cell, ending at the Heavy perimeter boundary. The current placement also
...
- Extend the transition over one full OpenGrid pitch, from the Full profile
...
- Add behavior-focused coverage for inward placement, full-cell span, corner
