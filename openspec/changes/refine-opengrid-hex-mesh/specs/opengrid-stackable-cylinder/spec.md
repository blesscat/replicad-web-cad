...
- **AND** no hexagonal opening may intersect an existing hole or the printable-rib keep-out around it
- **AND** the circular-floor layout MUST use all complete safe cells without leaving an avoidable broad empty quadrant
