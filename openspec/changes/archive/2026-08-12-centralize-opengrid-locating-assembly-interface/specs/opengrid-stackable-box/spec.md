...
- **AND** the socket MUST retain the fixed two-stage Ø4.55-to-Ø7.05 bore profile through the 5 mm bottom assembly
...
- **AND** the special sockets MUST retain their Ø7.05 mm shoulder-side retaining openings, planar shoulders, and Ø7 mm flange-retaining behavior
...
- **AND** its shoulder-side retaining opening MUST measure Ø7.05 mm and extend 2.0 mm toward the interior
...
- **WHEN** a Ø4.5 mm shaft with a Ø7 mm × 0.8 mm flange is inserted through a special corner mounting socket from inside the box
- **THEN** the Ø4.5 mm shaft MUST pass through the Ø7.05 mm shoulder-side opening and the Ø4.55 mm lower bore
- **AND** the Ø7 mm flange MUST be retained by the shoulder-side Ø7.05 mm opening
