...
When bottomHolesEnabled=true, every valid cylinder MUST contain one centered floor hole at (0, 0). From the outside bottom surface toward the interior, the hole profile MUST depend on the selected profile: in the default mode it MUST have a straight Ø4.55 mm section from nominal Z=0 through Z=4, followed by a straight Ø7.05 mm retaining opening from nominal Z=4 through Z=5; in thin-bottom mode it MUST have a straight Ø4.55 mm section from nominal Z=0 through Z=1, followed by a straight Ø7.05 mm retaining opening from nominal Z=1 through Z=2; in bottom-plate mode it MUST have a straight Ø4.55 mm section from nominal Z=0 through Z=2, followed by a straight Ø7.05 mm retaining opening from nominal Z=2 through Z=3. Each transition MUST be a planar shoulder at the selected first-section depth and MUST NOT be a taper or a chamfer. When bottomHolesEnabled=false, no center or outer bottom hole may be generated.
...
- **AND** the hole MUST change to a Ø7.05 mm retaining opening after 4 mm of axial depth
- **AND** the retaining section MUST terminate at the 5 mm interior floor surface
...
- **AND** the hole MUST change to a Ø7.05 mm retaining opening after 1 mm of axial depth
- **AND** the retaining section MUST terminate at the 2 mm central flat floor surface
