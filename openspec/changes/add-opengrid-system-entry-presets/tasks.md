...
- [x] 1.1 Write the proposal for Desk/Wall entry presets and context-specific preview assets.
...
- [x] 2.1 Add the `desk`/`wall` context type, query parser, preset resolver, and context-aware CAD path helper.
- [x] 2.2 Extend visible catalog grouping with Desk System and Wall Related entries without duplicating canonical model definitions.
...
- [x] 4.2 Add behavior-focused catalog and E2E coverage for distinct Desk/Wall preview metadata and routes.
...
## 6. Desk naming and preset revision
